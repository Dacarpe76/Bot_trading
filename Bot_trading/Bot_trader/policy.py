...
class Policy:
    ...
    def aplicar_politica(self, raw_weights, current_prices, holdings, avg_prices, regimen):
        ...
        cost_btc = avg_prices['BTC'] if avg_prices['BTC'] > 0 else btc_price
        cost_gold = avg_prices['GOLD'] if avg_prices['GOLD'] > 0 else gold_price
        ...
        # Pero portfolio.py tiene una regla HARD "No-Loss". Debemos decirle a portfolio que "ESTÁ OK VENDER".
        # Lo haremos pasando un flag 'allow_loss_sell' al portfolio, o asumiendo que el peso final manda.
        # AQUÍ solo ajustamos pesos.
